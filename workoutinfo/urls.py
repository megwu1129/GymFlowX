...
urlpatterns = [
    ...
    path('member/<int:pk>/delete/',
         ...
         name='workoutinfo_member_delete_urlpattern'),
    ...
    path('trainer/<int:pk>/delete/',
         TrainerDelete.as_view(),
         name='workoutinfo_trainer_delete_urlpattern'),
    ...
    path('workoutplan/<int:pk>/delete/',
         WorkoutPlanDelete.as_view(),
         name='workoutinfo_workoutplan_delete_urlpattern'),
    ...
    path('workout/<int:pk>/delete/',
         ...
         name='workoutinfo_workout_delete_urlpattern'),
    ...
    path('membership/<int:pk>/delete/',
         MembershipDelete.as_view(),
         name='workoutinfo_membership_delete_urlpattern'),
    ...
    path('payment/<int:pk>/delete/',
         ...
         name='workoutinfo_payment_delete_urlpattern'),
]
